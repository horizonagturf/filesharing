...
return [
    ...
    'bundle-password-required' => 'This share is password-protected. Enter the password to enable downloads.',
    'bundle-password-incorrect' => 'Incorrect password. Please try again.',
    'unlock-downloads' => 'Unlock downloads',
    ...
    'bundle-unavailable-expired' => 'This share has expired and is no longer available.',
    'bundle-unavailable-max-downloads' => 'This share has reached its download limit and is no longer available.',
    'bundle-unavailable-title' => 'Share unavailable',
    'bundle-unavailable-contact' => 'Contact the person who shared these files if you still need access.',
    'active' => 'Active',
    'expired' => 'Expired',
    ...
    'account-approval-override' => 'Approval override',
    'account-approval-inherit' => 'Inherits from groups / default',
    'account-approval-effective' => 'Approval required for uploads',
